...
HD_PWD='C:/Users/10957/Dropbox/PC/Documents/my university files/University of Bristol/DSP_FPGA/FPGA coursework/FPGA_PROJECT/fpga_coursework_simple/fpga_coursework_simple.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_sig.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_sig.tcl -notrace
